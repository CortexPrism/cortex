...
import { buildCliffyCommand, loadPluginCliModule } from '../plugins/extensions/cli.ts';
import { getEnabledPlugins } from '../plugins/registry.ts';
import type { CliCommandDeclaration, PluginManifest } from '../plugins/types.ts';
