      ...
      <div style="display:flex;flex-direction:column;gap:10px;">
        ...
        <div>
          ...
          <div style="display:flex;gap:6px;flex-wrap:wrap;margin-bottom:7px;">
            <button type="button" class="ag-tmpl-btn" data-val="developer" onclick="agSoulTemplate(this)" data-tooltip="Developer template" style="padding:3px 10px;border-radius:14px;border:1px solid var(--border);background:var(--bg3);color:var(--text2);cursor:pointer;font-size:10px;">👨‍💻 Developer</button>
            <button type="button" class="ag-tmpl-btn" data-val="professional" onclick="agSoulTemplate(this)" data-tooltip="Professional template" style="padding:3px 10px;border-radius:14px;border:1px solid var(--border);background:var(--bg3);color:var(--text2);cursor:pointer;font-size:10px;">💼 Professional</button>
            <button type="button" class="ag-tmpl-btn" data-val="friendly" onclick="agSoulTemplate(this)" data-tooltip="Friendly template" style="padding:3px 10px;border-radius:14px;border:1px solid var(--border);background:var(--bg3);color:var(--text2);cursor:pointer;font-size:10px;">😊 Friendly</button>
            <button type="button" class="ag-tmpl-btn" data-val="analyst" onclick="agSoulTemplate(this)" data-tooltip="Analyst template" style="padding:3px 10px;border-radius:14px;border:1px solid var(--border);background:var(--bg3);color:var(--text2);cursor:pointer;font-size:10px;">📊 Analyst</button>
            <button type="button" class="ag-tmpl-btn" data-val="minimalist" onclick="agSoulTemplate(this)" data-tooltip="Minimalist template" style="padding:3px 10px;border-radius:14px;border:1px solid var(--border);background:var(--bg3);color:var(--text2);cursor:pointer;font-size:10px;">◻ Minimalist</button>
            <button type="button" class="ag-tmpl-btn" data-val="creative" onclick="agSoulTemplate(this)" data-tooltip="Creative template" style="padding:3px 10px;border-radius:14px;border:1px solid var(--border);background:var(--bg3);color:var(--text2);cursor:pointer;font-size:10px;">🎨 Creative</button>
