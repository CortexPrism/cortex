import { type blue, type cyan, dim, type green, type magenta, type yellow } from '@std/fmt/colors';
import { ANSI_RESET, type ansiColor256, cursorPos, getTermSize } from './animations.ts';
