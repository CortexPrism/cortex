...
import { gitAdd, gitCommit, gitPush } from '../../../../../../src/workspace/git.ts';
import { ensureAgentWorkspace } from '../../../../../../src/workspace/paths.ts';

export const gitPushTool: Tool = {
  definition: {
    name: 'git_push',
    description:
      'Stage all changes, commit, and push to a remote repository. Creates a commit with the given message then pushes.',
