...
export const designToolInterfaceSkill: BuiltinSkill = {
  ...
  description:
    'Design tool parameters and responses so agents can use them reliably. Use when building new tools or APIs.',
  ...
  steps: [
    {
      step: 1,
      action: 'Design input parameters',
      description: 'Define required vs optional, types, validation rules, and examples',
    },
    {
      step: 2,
      action: 'Design output structure',
      description: 'Create consistent response format with success flag, data, and error fields',
    },
    {
      step: 3,
      action: 'Add error details',
      description: 'Include error codes, human-readable messages, and recovery suggestions',
    },
    {
      step: 4,
      action: 'Document constraints',
      description: 'Specify timeouts, rate limits, idempotency requirements',
    },
    {
      step: 5,
      action: 'Validate design',
      description: 'Test that agents can reliably call and handle tool responses',
    },
  ],
