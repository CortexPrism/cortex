  ...
  async run(ctx: PipelineContext): Promise<HookResult> {
    try {
      const {
        ...
        buildRequestContext,
        getCandidateModels,
      } = await import('../../../../src/model-quartermaster/mod.ts');
...
class DLPGuardHook implements PipelineHook {
  ...
  async run(ctx: PipelineContext): Promise<HookResult> {
    try {
      ...
      const { dlpMiddleware } = await import('../../../../src/security/dlp.ts');
...
class ComplianceHook implements PipelineHook {
  ...
  async run(ctx: PipelineContext): Promise<HookResult> {
    try {
      const { recordTurnCompliance } = await import('../../../../src/security/compliance.ts');
      const { classifyContent } = await import('../../../../src/security/classification.ts');
      ...
      if (ctx.stage === 'post-output') {
        ...
        const { extractHostnames } = await import('../../../../src/security/compliance.ts');
